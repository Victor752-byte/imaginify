...
export async function POST(req: Request) {
  ...
  if (eventType === "user.created") {
    ...
    const user = {
      ...
      username: username || "Anonymous", // Fallback to prevent crashes
      firstName: first_name || "First Name", // Fallback value
      lastName: last_name || "Last Name", // Fallback value
      photo: image_url || "", // Optional, can be empty
    };
...
//   console.log(`Webhook with and ID of ${id} and type of ${eventType}`);
//   console.log("Webhook body:", body);
//   console.log("Webhook payload received:", evt.data);
